...
class SubmitEmailWidget extends StatefulWidget {
  final SignUpDataEntity signUpDataModel;

  const SubmitEmailWidget({
    super.key,
    required this.signUpDataModel,
  });

  @override
  State<SubmitEmailWidget> createState() => _SubmitEmailWidgetState();
}

class _SubmitEmailWidgetState extends State<SubmitEmailWidget> {
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: BlocConsumer<PhoneOrEmailCubit, PhoneOrEmailState>(
            ...
            builder: (context, state) {
              final fieldModel = state.email;

              //Be sure to set a type for this widget.
              return PhoneEmailInput<EmailPasswordTextFieldS>(
                cubit: cubit,
        ...
        Padding(
          ...
          child: BlocBuilder<PhoneOrEmailCubit, PhoneOrEmailState>(
            builder: (context, state) {
